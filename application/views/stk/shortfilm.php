...
<div id="pagecontent">
   <div id="left-container">
      <div style="min-height:1278px">
    	<div class="orangeheader">Short Film Competition Entry Form</div>
...
There are <strong>two payment options</strong> for this application process – you can either pay online with a credit card or by posting in a cheque or money order. If you choose the online payment option, it must be competed at the end of this application – you cannot return and pay at another time.</p>
        ...
        <p>&nbsp;</p>
          ...
          <form name="shortfilmForm" id="shortfilmForm" method="post" action="<?=base_url()?>apply_form">
             <div class="form-row">
                <div class="row-title">
            ...
            <div class="form-row">
			 ...
			 -->
              ...
              <div class="form-row">
			  	<p style="line-height: 23px;padding-bottom:3px">Please note: The next 3 questions DO NOT effect your eligibility:</p>
                <div class="row-title">
             ...
             <div class="form-row">
                <div class="row-title">
                   Have you, or do you intend to enter any other Australian film festivals in 2010 or 2011
                </div>
                <div class="row-input">
                 ...
                 </select>&nbsp;<span id="student_production">please specify which festival &nbsp;&nbsp;<input type="text" name="other Australian film festivals intent to enter" />
